//
// Randomly places circles with greater density at top, separated into some layers for blurring ease
//
...
for (i=0; i<howMany; i++) {
	...
	var radius = Math.random()*sizeRange + 10;

//	var radius = Math.sqrt(area / Math.PI) * .05;
	var budget = layr.pathItems.ellipse(Math.random()*(Math.random()*-5472), Math.random()*6912, radius, radius, true, false);
/*
